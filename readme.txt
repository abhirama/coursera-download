...
2. Extract download.py and download.cfg files into the directory where you want to download files from Coursera.
...
5. Run the script periodically as the course contents are updated and the script takes care of downloading the newly updated files.
6. Script creates a directory called .info in the directory where it is present. Do not delete or tamper with this directory as this is where it keeps track of already downloaded files.
